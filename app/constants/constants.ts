...
export const TimeLineData = [
  ...
  { year: 2021, text: "Got my first job as a react developer intern." },
  {
    year: 2022,
    text: "Delved into Backend and explored tools like Nodejs and mongoDB, and became a react junior developer",
  },
  {
    year: 2023,
  ...
  {
    year: 2024,
    text: "Explore Infrasture setup and automation, using tools github action, Terraform, Ansible, Docker, Kubernetes etc.",
  },
];
